...
test('LIVE tracking accepts every provider competition and keeps Costa Rica canonical',async()=>{
 ...
 for(const id of [2,39,140,253,262,1028,999]) {
 ...
 assert.equal(isTrackedLiveFixture(fixture(null,'Spain')),false);
});
